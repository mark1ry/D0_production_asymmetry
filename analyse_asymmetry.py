...
def plot_histogram(val, result, uncertainty, text):
    ...
    ax.text(-1.8, 16, textstr, horizontalalignment='center', verticalalignment='center', bbox=dict(boxstyle='square,pad=1', fc='w', ec='k', alpha=1))
...
def plot_2Dhistogram(val):
    ...
    ax2.invert_yaxis()
    ax2.set_title(r"$A_{raw}$ distribution")
...
plot_histogram(asym_val, integrated[0], integrated[1])
plot_2Dhistogram(asym_val)